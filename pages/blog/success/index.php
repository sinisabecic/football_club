...
<body>
    ...
    <div class="page-holder">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail post-card hvr-hang">
                        ...
                        <div class="caption">
                            ...
                            <p><a href="<?php echo $actual_link.'single-post/?post='.$id; ?>"
                                    class="btn btn-primary" role="button">Pročitaj više</a></p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            $.toast({
                text: "Novost je uspješno dodata.", // Text that is to be shown in the toast
                heading: 'Uspješno', // Optional heading to be shown on the toast
